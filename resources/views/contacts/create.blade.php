                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('contacts.store') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="workphone" type="text" class="form-control @error('workphone') is-invalid @enderror" name="workphone" value="{{ old('workphone') }}">
                                @error('workphone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="homephone" type="text" class="form-control @error('homephone') is-invalid @enderror" name="homephone" value="{{ old('homephone') }}">
                                @error('homephone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
