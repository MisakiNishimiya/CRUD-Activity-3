        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-800">
                    <i class="fas fa-user-edit text-indigo-600 mr-2"></i>Edit Contact
                </h1>
                ...
                <div class="bg-gray-50 p-6 rounded-md shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="firstname" id="firstname" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('firstname', $contact->firstname) }}" required>
                        </div>
                        
                        <div>
                            <label for="lastname" class="block text-sm font-medium text-gray-700 mb-1">Last Name <span class="text-red-500">*</span></label>
                            <input type="text" name="lastname" id="lastname" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('lastname', $contact->lastname) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email" class="w-full pl-10 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('email', $contact->email) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="birthdate" id="birthdate" class="w-full pl-10 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('birthdate', $contact->birthdate->format('Y-m-d')) }}" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="workphone" id="workphone" class="w-full pl-10 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('workphone', $contact->workphone) }}">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="homephone" id="homephone" class="w-full pl-10 px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('homephone', $contact->homephone) }}">
                            </div>
                        </div>
                    </div>
                </div>
